...
const Project = () => {
  ...
  return (
    <div className="flex flex-col w-full max-w-5xl mx-auto gap-10 p-10 border shadow-lg rounded-lg bg-white">
      {/* 헤더 */}
      ...
      <div className="flex flex-col gap-10">
        {/* 첫 번째 프로젝트 (4개월차) */}
        <div className="flex flex-col gap-5 border-b-2 border-gray-300 pb-5">
          ...
          <div className="bg-gray-100 p-4 rounded-lg shadow-md">
            <div className="font-semibold text-lg">사용한 스펙</div>
            <div className="mt-2">
              ...
              <div className="flex items-center">
                ...
                <span className="ml-2 text-gray-600">Node.js + Express.js</span>
              </div>
              <div className="flex items-center">
        ...
        <div className="flex flex-col gap-5 border-b-2 border-gray-300 pb-5">
          ...
          <div className="bg-gray-100 p-4 rounded-lg shadow-md">
            ...
            <div className="mt-2">
              ...
              <div className="flex items-center">
                <span className="font-medium">백엔드:</span>
                <span className="ml-2 text-gray-600">SpringBoot</span>
              </div>
              <div className="flex items-center">
                <span className="font-medium">데이터베이스:</span>
                <span className="ml-2 text-gray-600">MySQL</span>
